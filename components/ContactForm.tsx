...
export default function ContactForm() {
  ...
  const [f, setF] = useState<FormState>({ name: '', email: '', msg: '' });
    ...
    >
      {sent ? (
        <div className="w-form__done">
          ...
          <p className="w-lead">
            This is a demo form. In production it would reach recruit@shonie.dev.
          </p>
          <Button
            variant="outline"
            onClick={() => {
        ...
        <>
          <label className="w-field">
            <span>Name</span>
            <input value={f.name} onChange={upd('name')} required placeholder="Your name" />
          </label>
          <label className="w-field">
            <span>Email</span>
            <input
