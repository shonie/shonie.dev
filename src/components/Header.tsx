...
import { Flex, Separator, Heading } from '@radix-ui/themes';
...
export const Header = () => {
  ...
  const matches = useMediaQuery('(max-width: var(--1024px))');

  return (
    <header className="flex flex-row w-full fixed top-0 p-6 rounded-xs border-b-1 min-w-100 pl-6 backdrop-blur-sm transition-all duration-200 ease-in border-gray-700 z-9">
